    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addToCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (states == "Terkirim" || states == "tidak terkirim") {

                    Toast.makeText(ProductDetailsActivity.this, "Mohon konfirmasi pesanan anda sebelumnya", Toast.LENGTH_LONG).show();
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    cardListRef.child("Admin View").child(Prevalent.currentOnlineUser.getPhone()).child("Products").child(productID).
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(ProductDetailsActivity.this, "Produk ditambahkan ke keranjang", Toast.LENGTH_SHORT).show();
