...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgetPwd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(LoginActivity.this, "Segera Hadir", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void loginUser() {
        ...
        if (TextUtils.isEmpty(phone)) {
            Toast.makeText(this, "Tolong masukan nomor anda...", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(password)) {
            Toast.makeText(this, "Tolong masukan kata sandi anda...", Toast.LENGTH_SHORT).show();
        } else {
            loadingBar.setTitle("Koneksi");
            loadingBar.setMessage("Mohon bersabar");
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(parentDbName).child(phone).exists()) {
                    ...
                    Toast.makeText(LoginActivity.this, "Akun ini tidak ada", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
