...
import static com.emst.cours.ecommerce.R.id.total_price;
                                    ...
                                    cardListRef.child("User View").child(Prevalent.currentOnlineUser.getPhone())
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()){
                                                Toast.makeText(CardActivity.this, "Produk dihapus", Toast.LENGTH_SHORT).show();
                                                Intent intent = new Intent(CardActivity.this,HomeActivity.class);
                                                startActivity(intent);
                                            }
                                        }
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    if (state.equals("buku")){
                        recyclerView.setVisibility(View.GONE);
                        msg.setVisibility(View.VISIBLE);
                        msg.setText("Terimakasih, pesanan anda terkirim");
                        btn_next.setVisibility(View.GONE);

                    }else if (state.equals("tidak terkirim")){
                        recyclerView.setVisibility(View.GONE);
                        msg.setVisibility(View.VISIBLE);
                        btn_next.setVisibility(View.GONE);
