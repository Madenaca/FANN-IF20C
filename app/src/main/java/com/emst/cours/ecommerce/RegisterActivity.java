...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void createAccount()
    {
        ...
        {
            Toast.makeText(this, "Silahkan masukan nama anda...", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(phone))
        {
            Toast.makeText(this, "Silahkan masukan nomor anda", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(password))
        {
            Toast.makeText(this, "Silahkan masukan kata sandi anda...", Toast.LENGTH_SHORT).show();
        }
        else
        {
            loadingBar.setTitle("Pembuatan akun");
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                    ...
                    RootRef.child("Users").child(phone).updateChildren(userdataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task)
                                {
                                    ...
                                    {
                                        loadingBar.dismiss();
                                        Toast.makeText(RegisterActivity.this, "Sambungan error", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
                else
                {
                    ...
                    loadingBar.dismiss();
                    Toast.makeText(RegisterActivity.this, "Silahkan pilih nomor yang lain", Toast.LENGTH_SHORT).show();
